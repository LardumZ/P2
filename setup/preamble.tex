...
\usepackage{amssymb} 
% \usepackage{mathabx}			            % Andre matematik- og tegnudvidelser (commented out due to conflicts)

% Import only the diameter symbol from mathabx to avoid conflicts
\DeclareFontFamily{U}{mathx}{\hyphenchar\font45}
\DeclareFontShape{U}{mathx}{m}{n}{<-> mathx10}{}
\DeclareSymbolFont{mathx}{U}{mathx}{m}{n}
\DeclareMathSymbol{\diameter}{\mathord}{mathx}{"3F}
...
% ¤¤ Chemistry ¤¤ %
\usepackage{chemfig}                        % Kemi streg figure
