...
\plainbreak{2}
\input{Sections/4 Kravspecifikation/House of Quality}
\plainbreak{2}
\input{Sections/4 Kravspecifikation/Trin 1, 2 , 3 og 4} \plainbreak{2}
\input{Sections/4 Kravspecifikation/Trin 5}
\plainbreak{2}
\input{Sections/4 Kravspecifikation/Trin 6}
\plainbreak{2}
\input{Sections/4 Kravspecifikation/Trin 7}
\plainbreak{2}
\input{Sections/4 Kravspecifikation/Trin 8}
\plainbreak{2}
\input{Sections/4 Kravspecifikation/Endelige kravspecifikationer}
